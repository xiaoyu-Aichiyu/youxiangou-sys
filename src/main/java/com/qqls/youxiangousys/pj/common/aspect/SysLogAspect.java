package com.qqls.youxiangousys.pj.common.aspect;

import com.qqls.youxiangousys.pj.common.annotation.RequiredLog;
import com.qqls.youxiangousys.pj.common.util.IPUtils;
import com.qqls.youxiangousys.pj.common.util.ShiroUtil;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.qqls.youxiangousys.pj.common.annotation.RequiredLog)")
    public void saveLog(){}
    ...
    public void insertLog(long time, ProceedingJoinPoint jp) throws Exception {
        ...
        SysLog log = new SysLog(0, "admin", operation, methodName, argsStr, time, ip, new Date());
